 ...
 * @since 0.1.0
 */
class DisableMessagesAction extends SessionFilterAction {
	...
	public function run() {
		...
		//改变评论读取状态
		$ids = explode(',', $ids);
		Messages::model()->disableMessages($ids, $isDelete);
		$this->addResponse(Contents::RESULT,true);
		$this->addResponse(Contents::DATA,array('messageIds'=>$ids));
		$this->sendResponse();
	}
}
