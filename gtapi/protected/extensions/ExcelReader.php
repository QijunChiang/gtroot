        ...
        if($this->excel instanceof Spreadsheet_Excel_Reader){
                ...
                foreach($data['cells'] as $col => $cell){
                        if($col == 1){
                                ...
                                $row = array();$row_mis = array();
                                foreach($fields as $findex => $fval){
                                	if($col != $i){
                                		$row_mis[$findex-1] = NULL;
                                	}
                                	//$row[$fval] = ($cell[$findex]?$cell[$findex]:NULL);
                                	//start edit
                                        if(array_key_exists($findex, $cell)){
                                        	$row[$findex-1] = ($cell[$findex]?$cell[$findex]:NULL);
                                        }else{
                                        	$row[$findex-1] = NULL;
                                        }
                                    //end edit
                ...
                foreach($cells as $col => $cell){
                        if($col == 0){
                                ...
                                foreach($fields as $findex => $fval){
                                	...
                                	//start edit
                                	if(array_key_exists($findex, $cell)){
                                        $row[$findex] = ($cell[$findex]?$cell[$findex]:NULL);
                                	}else{
                                		$row[$findex] = NULL;
                                	}
                                	//end edit
