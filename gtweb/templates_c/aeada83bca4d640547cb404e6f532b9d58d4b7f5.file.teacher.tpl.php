<?php /* Smarty version Smarty-3.1.16, created on 2014-02-28 09:14:08
         compiled from "D:\xampp2\htdocs\gtweb\templates\teacher.tpl" */ ?>
<?php /*%%SmartyHeaderCode:97655310455028b900-52746348%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'aeada83bca4d640547cb404e6f532b9d58d4b7f5' => 
    array (
      0 => 'D:\\xampp2\\htdocs\\gtweb\\templates\\teacher.tpl',
      1 => 1393558640,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '97655310455028b900-52746348',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_53104550473100_49837291',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_53104550473100_49837291')) {function content_53104550473100_49837291($_smarty_tpl) {?>﻿<?php echo $_smarty_tpl->getSubTemplate ("header.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0);?>
...
" width="640" height="264" alt="Poster Image" title="No video playback capabilities." />
	  ...
	  <!-- End VideoJS -->
	  <?php } elseif (count($_smarty_tpl->tpl_vars['teacher']->value->introduction->image)>1&&$_smarty_tpl->tpl_vars['teacher']->value->introduction->image[1]->image) {?>
	  <div class="video_in"><img style='width:960px;height:360px;' src="<?php echo $_smarty_tpl->tpl_vars['__GTAPI_BASE_URL']->value;?>
<?php echo $_smarty_tpl->tpl_vars['teacher']->value->introduction->image[1]->image;?>
" alt=""/></div>
	  <?php } else { ?>
	  <div class="video_in"><img style='width:960px;height:360px;' src="<?php echo @constant('__SITE_PATH');?>
/images/01.jpg" alt=""/></div>
	  <?php }?>
  </div>
...
, <?php echo $_smarty_tpl->tpl_vars['teachCourse']->value->location->x;?>
					...
					var infoWindow = new BMap.InfoWindow("<?php echo $_smarty_tpl->tpl_vars['teachCourse']->value->location->info;?>
", opts);  // 创建信息窗口对象
      ...
      <div class="comment"> 
        ...
        <div class="points">
          <div class="cont layout"> <span class="head">分数</span>
            <div class="star star<?php echo $_smarty_tpl->tpl_vars['teacher']->value->star*10;?>
"></div>
