<?php /* Smarty version Smarty-3.1.16, created on 2014-02-20 02:59:17
         compiled from "d:\Wnmp\html\goodteacher\gtweb\templates\header.tpl" */ ?>
<?php /*%%SmartyHeaderCode:13651722045305b5d59243a8-03384990%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '550a03951f12b7055562fd60523231c64d0f3723' => 
    array (
      0 => 'd:\\Wnmp\\html\\goodteacher\\gtweb\\templates\\header.tpl',
      1 => 1392877450,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '13651722045305b5d59243a8-03384990',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5305b5d5c45172_87389504',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5305b5d5c45172_87389504')) {function content_5305b5d5c45172_87389504($_smarty_tpl) {?><!doctype html>
<html>
<head>
<meta charset="utf-8">
...
<script type="text/javascript">
$(function(){
    $(".nav_list_b ul li").mouseover(function(){$(this).css("background", "#f5f5f5"),function(){$(this).children().css("display", "none")}});
	$(".nav_list_b ul li").mouseover(function(){$(this).children(".nav_list_b ul li ul").css("display", "block")});
	$(".nav_list_b ul li").mouseout(function(){$(this).css("background", "#fff")});
	$(".nav_list_b ul li").mouseout(function(){$(this).children(".nav_list_b ul li ul").css("display", "none")});
	
	$("#study li ul li").mouseover(function(){$(this).css("background", "#e0e0e0")});
	$("#study li ul li").mouseout(function(){$(this).css("background", "#f5f5f5")});
	
	$(".nav_list_in").toggle(function(){
		$(this).parent().css("backgroundImage", "url(images/nav_list.gif)");
		$("#study").fadeIn(200);
		$(".city_in").stop(false,true).fadeOut(200);
	},function(){
	...
	$("#city").toggle(function(){
		...
		$(".city_in").fadeIn(200);
		$("#study").stop(false,true).fadeOut(200);
	},function(){
	...
	$('body').click(function(){
		...
		$("#study").stop(false,true).fadeOut(200);
		$(".city_in").stop(false,true).fadeOut(200);
		$("#shareList").stop(false,true).fadeOut(200);	
		$(".user_info_b").stop(false,true).fadeOut(200);			
	});
	//登录
